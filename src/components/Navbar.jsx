      ...
      >
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex items-center justify-between h-16 md:h-20">
            ...
            {/* ── Logo ─────────────────────────────────────── */}
            <a href="#home" className="flex items-center gap-2.5 group" aria-label="Oxford Group – Home">
              ...
              <div className="leading-tight">
                <span className={`block text-lg font-bold tracking-tight transition-colors duration-300 ${scrolled ? 'text-oxford-800' : 'text-white'}`}>
                  Oxford <span className="text-gold-500">Group</span>
                </span>
                <span className={`block text-[10px] font-medium tracking-widest uppercase transition-colors duration-300 ${scrolled ? 'text-gray-400' : 'text-blue-200'}`}>
                  Language Center
                </span>
              </div>
            </a>
                  ...
                  <a
                    ...
                    className={`flex items-center gap-1 px-4 py-2 rounded-full text-sm font-medium transition-all duration-200
                      ${activeNav === link.href.replace('#', '')
                        ? (scrolled ? 'text-oxford-700 bg-oxford-50' : 'text-white bg-white/20')
                        : (scrolled ? 'text-gray-600 hover:text-oxford-700 hover:bg-oxford-50' : 'text-blue-100 hover:text-white hover:bg-white/20')
                      }`}
            ...
            <div className="hidden lg:flex items-center gap-3">
              <a
                href="#contact"
                className={`text-sm font-medium transition-colors duration-200 ${scrolled ? 'text-gray-600 hover:text-oxford-700' : 'text-blue-100 hover:text-white'}`}
              >
                Log In
              </a>
              <a
            ...
            {/* ── Mobile toggle ─────────────────────────────── */}
            <button
              className={`lg:hidden p-2 rounded-xl transition-colors duration-200 ${scrolled ? 'text-gray-700 hover:bg-gray-100' : 'text-white hover:bg-white/20'}`}
        ...
        >
          <div className="px-4 py-4 space-y-1">
            ...
            <div className="pt-4 border-t border-gray-100 flex flex-col gap-3">
              ...
              <a href="#placement" onClick={() => setOpen(false)} className="btn-secondary justify-center">
                Take Placement Test
              </a>
            </div>
          </div>
